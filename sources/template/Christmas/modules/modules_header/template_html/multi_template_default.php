      ...
      <div class="row">
        ...
        <span class="col-md-6 col-sm-12  text-center">
          ...
          <div class="input-group col-md-12 advancedSearchCriteria">
            ...
            <span id="buttonKeywordsSearch"><?php echo HTML::button(null, 'bi bi-search', null, 'danger', null, 'md'); ?></span>
          </div>
          ...
          <span class="col-md-4 text-end headerMultiTemplateDefaultTitle">
<?php
...
?>
      ...
      <div class="row col-md-12">
        ...
        <span class="col-md-6 col-sm-6 text-end"><?php echo $banner_header; ?></span>
