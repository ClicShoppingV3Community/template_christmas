      ...
      <div class="row">
        ...
        <span class="col-md-6 col-sm-12  text-md-center">
          ...
          <div class="input-group col-md-12 advancedSearchCriteria">
            ...
            <span id="buttonKeywordsSearch"><?php echo HTML::button(null, 'fas fa-search', null, 'danger', null, 'md'); ?></span>
          </div>
          ...
          <span class="col-md-4 text-md-right headerMultiTemplateDefaultTitle">
<?php
...
?>
      ...
      <div class="row col-md-12">
        ...
        <span class="col-md-6 col-sm-6 text-md-right"><?php echo $banner_header; ?></span>
